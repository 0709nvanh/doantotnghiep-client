            ...
            <div className="container outstory mt-5 ">
                ...
                <div className="d-flex">
                    <div className="col-4 outstory-span border-5 border-start ps-5 pe-5">
                        <span className="lh-lg">“Thương hiệu sách VÂN ANH là địa chỉ tin cậy cho các tác giả trẻ Việt Nam gửi gắm tác phẩm của mình. Với khẩu hiệu “Tôi trẻ, tôi đam mê”, chúng tôi luôn nỗ lực để mang đến cho độc giả những tác phẩm chất lượng từ các tác giả trẻ nổi bật cũng như giúp đỡ, tạo điều kiện cho các cây bút trẻ được đông đảo độc giả biết đến. Hãy để NHÀ SÁCH VÂN ANH trở thành người đưa đứa con tinh thần của bạn đến với công chúng!”</span>
                    </div>
                    <div className="col-8">
                        <div className="mt-2">
                ...
                <div className="d-flex">
                    ...
                    <div className="col-9 ps-5">
                        <div >
                            ...
                            <p>Gửi tặng tất cả những thành viên của NHÀ SÁCH VÂN ANH, độc giả và dù bạn là ai, vô tình đọc được post này, xin trân trọng dành cho bạn vô vàn yêu thương.

                                8 năm, không phải là quá dài, nhưng cũng là một khoảng thời gian đủ dài để NHÀ SÁCH VÂN ANH trở thành một dấu ấn không thể quên đối với rất nhiều người. Từ những thành viên đầu tiên, tới những độc giả dù thân quen hay mới mẻ, tất cả đều là những mảnh ghép không thể thiếu để tạo nên NHÀ SÁCH VÂN ANH ngày hôm nay, với sứ mệnh đem đến cho thế hệ trẻ hiện đại những tri thức và cả những sự giải trí rất văn minh.

                                8 năm, là hành trình của rất nhiều sự nỗ lực của những người đặt nền móng đầu tiên tới những người vẫn còn ở lại đồng hành cho tới tận bây giờ. Tuy rằng, có rất nhiều lúc, nước mắt đã rơi, mồ hôi mướt mát, nhưng họ vẫn luôn yêu thương và hướng về NHÀ SÁCH VÂN ANH với tất cả những tình cảm chân thành và dịu dàng nhất.

                                8 năm, một hành trình trao gửi yêu thương, vẫn tiếp diễn và còn rất nhiều bất ngờ cũng như khó khăn ở phía trước. Nhưng không vì vậy, mà NHÀ SÁCH VÂN ANH dừng bước hay mỏi mệt. Bởi vì độc giả vẫn ở đấy, luôn yêu thương và chờ đợi, nên NHÀ SÁCH VÂN ANH cũng sẽ luôn ở đây, sẵn sàng lắng nghe và luôn luôn thấu hiểu.

                                Cảm ơn vì 8 năm với biết bao thăng trầm và thay đổi. Dù bạn là bất cứ ai, NHÀ SÁCH VÂN ANH cũng luôn biết ơn và yêu thương bạn. Bởi vì bạn, là một phần tuyệt vời nhất của tất cả chúng tôi ❤
